...
namespace WebApi.Controllers
{
    ...
    public class RolUserController : ControllerBase
    {
        ...
        private readonly ISGeneric<RolUser, RolUserDTO> _Servicio;
        public RolUserController(ISGeneric<RolUser, RolUserDTO> servicio)
        {
            _Servicio = servicio;
        }
