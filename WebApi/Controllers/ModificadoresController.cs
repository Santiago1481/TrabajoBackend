...
namespace WebApi.Controllers
{
    ...
    public class ModificadoresController : ControllerBase
    {
        ...
        private readonly ISGeneric<Modificadores, ModificadoresDTO> _Servicio;
        public ModificadoresController(ISGeneric<Modificadores, ModificadoresDTO> servicio)
        {
            _Servicio = servicio;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] ModificadoresDTO dto)
        {
        ...
        // PUT: api/modificadores
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ModificadoresDTO dto)
        {
